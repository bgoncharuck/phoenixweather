...
class ShowBloc extends Bloc<ShowEvent, ShowState> {
  ...
  void calculateDaysOfMonth() {
    ...
    // tomorrow
    days[2]= (DateTime.fromMillisecondsSinceEpoch(data.hourly[30].dt*1000)).day;
    // other
    days[3]= (DateTime.fromMillisecondsSinceEpoch(data.daily[2].day.dt*1000)).day;
    days[4]= (DateTime.fromMillisecondsSinceEpoch(data.daily[3].day.dt*1000)).day;
    days[5]= (DateTime.fromMillisecondsSinceEpoch(data.daily[4].day.dt*1000)).day;
    days[6]= (DateTime.fromMillisecondsSinceEpoch(data.daily[5].day.dt*1000)).day;
    days[7]= (DateTime.fromMillisecondsSinceEpoch(data.daily[6].day.dt*1000)).day; 
  }
}
