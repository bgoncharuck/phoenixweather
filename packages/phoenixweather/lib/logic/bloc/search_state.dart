...
class SearchStatePrevious extends SearchState {
  final LatLonApiModel location;
  final CurrentData data;

  const SearchStatePrevious({this.location = null, @required this.data});
...
class SearchStateSuccess extends SearchState {
  ...
  const SearchStateSuccess({@required this.location, @required this.data});
